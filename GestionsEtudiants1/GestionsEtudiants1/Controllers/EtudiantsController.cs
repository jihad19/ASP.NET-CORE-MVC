...
using GestionsEtudiants1.Data;
using GestionsEtudiants1.Models;

namespace GestionsEtudiants1.Controllers
{
    public class EtudiantsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,nom,prénom,CIN,Adresse")] Etudiant etudiant)
        {
